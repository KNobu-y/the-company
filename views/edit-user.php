    ...
    <main class="row justify-content-center gx-0">
        <div class="col-6">
            ...
            <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
                <div class="row justifi-content-center mb-3"> <!--Upload a file-->
                    <div class="col-6">
                        <?php
                        if($user['photo']){
                        ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" id="first_name" value="<?= $user['first_name']?>" required autofocus>
                </div>

    ...
    <div style="height: 100vh">
        <div class="row h-100 m-0">
            <div class="card w-25 my-auto mx-auto">
                ...
                <div class="card-body">
                    <form action="../actions/login.php" method="post"> <!--bring us lonin.php inside actions file-->
                    ...
                    <a href="../views/register.php" class="btn btn_outline-primary w-100 mt-2">Register</a></p>
                </div>
            </div>
        </div>
    </div>

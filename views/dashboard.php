...
require "../classes/User.php"; // to call here get_allusers
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($_SESSION['id'] == $user['id']){?>
                                    <a href="edit-user.php" class="btn btn-outline-secondary border-0 btn-sm" title="Edit"><i class="fa-solid fa-pen"></i></a>
                                    <a href="delete-user.php" class="btn btn-outline-danger border-0 btn-sm" title="delete"><i class="fa-solid fa-user-minus"></i></a>
                                <?php } ?>
                            </td>
                        </tr>                    
                    <?php
